...
public class GlobalClass extends Application {
    ...
    public GlobalClass(double latitud, double longitud, double velocidad, String nombreTransporte, String numVehiculo, String idDispositivo, String tipoUs, String ruta) {
